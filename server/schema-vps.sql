-- ScorpiCore Database Schema (Hostinger VPS)
-- Run this in phpMyAdmin or MySQL CLI
-- NOTE: Database should already exist on Hostinger
...
-- Insert default data
INSERT IGNORE INTO services (title, description, features, icon, color, sort_order) VALUES
...
INSERT IGNORE INTO plans (name, price, description, features, popular, sort_order) VALUES
...
INSERT IGNORE INTO projects (title, category, description, sort_order) VALUES
